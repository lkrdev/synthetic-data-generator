...
bq --project_id="${PROJECT_ID}" load --source_format=PARQUET --replace --autodetect "${PROJECT_ID}:${DATASET_ID}.accounts" "/tmp/pytest/pytest-11/test_export_to_bigquery_fallba0/accounts.parquet"